...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__8461__auto__,writer__8462__auto__,opt__8463__auto__){return cljs.core._write.call(null,writer__8462__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_27156 = (0);while(true){
if((i_27156 < arr.length))
{(arr[i_27156] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__8461__auto__,writer__8462__auto__,opt__8463__auto__){return cljs.core._write.call(null,writer__8462__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_27163 = (self__.level + (1));while(true){
if((i_27163 <= (new_level + (1))))
{(update[i_27163] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_27165 = (0);while(true){
if((i_27165 <= self__.level))
{var links_27166 = (update[i_27165]).forward;if(((links_27166[i_27165]) === x__$1))
{(links_27166[i_27165] = (x__$1.forward[i_27165]));
{
var G__27167 = (i_27165 + (1));
i_27165 = G__27167;
continue;
}
} else
{{
var G__27168 = (i_27165 + (1));
i_27165 = G__27168;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__7894__auto__ = (cljs.core.truth_((function (){var and__7882__auto__ = me;if(cljs.core.truth_(and__7882__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__7882__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__7894__auto__))
...
cljs.core.async.impl.dispatch.queue_delay.call(null,((function (timeout_channel,or__7894__auto__,timeout__$1,me){
return (function (){cljs.core.async.impl.timers.timeouts_map.remove(timeout__$1);
return cljs.core.async.impl.protocols.close_BANG_.call(null,timeout_channel);
});})(timeout_channel,or__7894__auto__,timeout__$1,me))
,msecs);
