...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t27255 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t27255 = (function (val,box,meta27256){
this.val = val;
this.box = box;
this.meta27256 = meta27256;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 425984;
})
cljs.core.async.impl.channels.t27255.cljs$lang$type = true;
cljs.core.async.impl.channels.t27255.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t27255";
cljs.core.async.impl.channels.t27255.cljs$lang$ctorPrWriter = (function (this__8461__auto__,writer__8462__auto__,opt__8463__auto__){return cljs.core._write.call(null,writer__8462__auto__,"cljs.core.async.impl.channels/t27255");
});
cljs.core.async.impl.channels.t27255.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t27255.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_27257){var self__ = this;
var _27257__$1 = this;return self__.meta27256;
});
cljs.core.async.impl.channels.t27255.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_27257,meta27256__$1){var self__ = this;
var _27257__$1 = this;return (new cljs.core.async.impl.channels.t27255(self__.val,self__.box,meta27256__$1));
});
cljs.core.async.impl.channels.__GT_t27255 = (function __GT_t27255(val__$1,box__$1,meta27256){return (new cljs.core.async.impl.channels.t27255(val__$1,box__$1,meta27256));
});
}
return (new cljs.core.async.impl.channels.t27255(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__8464__auto__,writer__8465__auto__,opts__8466__auto__){return cljs.core._write.call(null,writer__8465__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__8461__auto__,writer__8462__auto__,opt__8463__auto__){return cljs.core._write.call(null,writer__8462__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_27258 = self__.takes.pop();if((taker_27258 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_27258))
{var take_cb_27259 = cljs.core.async.impl.protocols.commit.call(null,taker_27258);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_27259,taker_27258,this$__$1){
return (function (){return take_cb_27259.call(null,null);
});})(take_cb_27259,taker_27258,this$__$1))
);
} else
{}
{
