...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_27249 = (0);while(true){
var m_27250 = cljs.core.async.impl.dispatch.tasks.pop();if((m_27250 == null))
{} else
{m_27250.call(null);
if((count_27249 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__27251 = (count_27249 + (1));
count_27249 = G__27251;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__7882__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__7882__auto__)
