...
*/
om_tools.dom.opt_key_case = (function opt_key_case(attr){if(cljs.core.truth_((function (){var or__7897__auto__ = (cljs.core.count.call(null,attr) < (5));if(or__7897__auto__)
...
*/
om_tools.dom.opt_key_alias = (function opt_key_alias(opt){var G__18691 = (((opt instanceof cljs.core.Keyword))?opt.fqn:null);switch (G__18691) {
case "for":
...
{return cljs.core.clj__GT_js.call(null,cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,(function (p__18695){var vec__18696 = p__18695;var k = cljs.core.nth.call(null,vec__18696,(0),null);var v = cljs.core.nth.call(null,vec__18696,(1),null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [om_tools.dom.format_opt_key.call(null,k),om_tools.dom.format_opt_val.call(null,v)], null);
}),opts)));
} else
{return opts;
}
...
om_tools.dom.element = (function element(ctor,opts,children){var vec__18698 = om_tools.dom.element_args.call(null,opts,children);var opts__$1 = cljs.core.nth.call(null,vec__18698,(0),null);var children__$1 = cljs.core.nth.call(null,vec__18698,(1),null);return cljs.core.apply.call(null,ctor,cljs.core.flatten.call(null,cljs.core.cons.call(null,opts__$1,children__$1)));
});
