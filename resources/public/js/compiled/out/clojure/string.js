...
{{
var G__24587 = cljs.core.pop.call(null,v__$1);
v__$1 = G__24587;
continue;
}
} else
...
{var pred__24591 = cljs.core._EQ_;var expr__24592 = limit;if(cljs.core.truth_(pred__24591.call(null,(1),expr__24592)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__24591.call(null,(2),expr__24592)))
...
var G__24594 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__24595 = (limit__$1 - (1));
var G__24596 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__24594;
limit__$1 = G__24595;
parts = G__24596;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___24598 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___24598))
{var replacement_24599 = temp__4124__auto___24598;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_24599)));
} else
{buffer.append(ch);
}
{
var G__24600 = (index + (1));
index = G__24600;
continue;
}
}
